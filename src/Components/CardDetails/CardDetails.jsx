          ...
          >
            ...
            <div className="hero-content text-center text-neutral-content">
              ...
              >
                ...
                <button  className="btn mt-5 text-lg bg-gradient-to-r hover:from-green-400 hover:to-blue-500 from-pink-500 to-yellow-500 shadow-lg shadow-blue-600/50 text-white">
                  Order Now
                </button>
              </div>
            </div>
